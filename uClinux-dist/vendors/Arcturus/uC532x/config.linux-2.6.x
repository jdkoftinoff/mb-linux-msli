...
# Boot configuration
#
CONFIG_UCBOOTLOADER=y
# CONFIG_UCBOOTLOADER_HIMEM_STACK is not set
CONFIG_UCBOOTLOADER_INTERNAL_STACK=y
CONFIG_UCBOOTSTRAP=y
CONFIG_UCBOOTLOADER_DOUBLE_JUMP=y
CONFIG_UNCACHED_REGION=y
CONFIG_UNCACHED_REGION_DMEM=y
# CONFIG_UNCACHED_REGION_TMEM is not set
CONFIG_UNCACHED_REGION_MASK=0x2000000
...
CONFIG_FB_FS453_TVOUT=y
# CONFIG_FB_NTSC is not set
# CONFIG_FB_PAL is not set
CONFIG_FB_VGA=y
...
CONFIG_LOGO_ARCTURUS_CLUT224=y
