...
volatile sig_atomic_t persistenced_sigusr1_received_count=0;
sig_atomic_t persistenced_sigusr1_last_count=0;
...
void do_persistent_load( char *argv0,  char **env)
{
    ...
    {
        printf("Unable to create /var/tmp/persist-loaded\n" );
    }
}
