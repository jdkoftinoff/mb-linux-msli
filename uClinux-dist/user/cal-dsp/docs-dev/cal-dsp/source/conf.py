# -*- coding: utf-8 -*-
#
# D-Mitri I/O Module OSC Control documentation build configuration file, created by
# sphinx-quickstart on Thu Jul 29 15:00:29 2010.
#
...
extensions = ['sphinx.ext.autodoc','rst2pdf.pdfbuilder','sphinx.ext.todo']
...
project = u'D-Mitri I/O Module OSC Control'
copyright = u'2010, Meyer Sound'

TITLE=project
DESCRIPTION="Open Sound Control Addresses and Communication Methods for control all D-Mitri I/O Modules"
KEYWORDS = "OSC D-Mitri I/O"
...
html_theme_options = {
    "linkcolor" : "#000099",
    "visitedlinkcolor" : "#000099",
    "hoverlinkcolor" : "#4444cc",
    }
...
latex_documents = [
  ('index', 'IO-OSC.tex', u'D-Mitri I/O Module OSC Control Documentation',
   u'Jeff Koftinoff', 'manual'),
]


#latex_elements = {
#    'releasename': '',
#    'maketitle': '\\makemslititle'
#    }
...
latex_preamble = """
   ...
   \\newcommand{\\website}[1]{\\href{http://#1}{#1}}
   \\newcommand{\\httpswebsite}[1]{\\href{https://#1}{#1}}
   \\newcommand{\\emaillink}[1]{\\href{mailto:#1}{<#1>}}
   \\newcommand{\\makemslititle}{
   \\begin{titlepage}
   \\begin{center}
   \\textsc{\\huge  """ + TITLE + """}\\\\\\textsc{v""" + version+ """ \\today}\\\\[8cm]
   \\begin{minipage}{0.7\\textwidth}
   \\begin{center}
   \\bfseries \\abstractname\\\\[0.5cm]
   \\end{center}
""" + DESCRIPTION + """
   \\end{minipage}\\\\[2cm]
   ...
   \\begin{center}
   \\bfseries Keywords\\\\[0.5cm]
""" + KEYWORDS + """
   \\end{center}
   \\end{minipage}
   \\vfill{
   Jeff Koftinoff \\emaillink{jeffk@meyersound.com}
   }
   \\end{center}
   \\end{titlepage}
   \\cleardoublepage
...
pdf_documents = [ ('index', u'IO-OSC', u'IO-OSC Documentation', u'Jeff Koftinoff'), ]
# A comma-separated list of custom stylesheets. Example:
pdf_stylesheets = ['sphinx','kerning','a4', 'autumn' ]
