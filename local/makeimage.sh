...
if [ -z "${DMITRI_IO_MAINT_DOWNLOAD_BIT}" ]; then
  DMITRI_IO_MAINT_DOWNLOAD_BIT="${HOME}/msli-avb/IO_Link/FPGA/Synthesis/IO_Link_top.bit"
fi

if [ -z "${DMITRI_IO_AVB_DOWNLOAD_BIT}" ]; then
  DMITRI_IO_AVB_DOWNLOAD_BIT="${HOME}/msli-avb/IO_Link/FPGA/Synthesis/IO_Link_top.bit"
fi

#if [ -z "${DMITRI_DGPIO_AVB_DOWNLOAD_BIT}" ]; then
#  DMITRI_DGPIO_AVB_DOWNLOAD_BIT="${HOME}/msli-avb/IO_Link/FPGA_DGPIO/Synthesis/IO_Link_top.bit"
#fi
